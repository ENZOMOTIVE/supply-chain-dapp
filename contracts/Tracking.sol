...
contract Tracking{
    ...
    TypeShipment [] typeShipments; // in this we keep shipment data so we can fetch it and display it in the frontend
    ...
    function completeShipment(address _sender,address _receiver, uint256 _index) public {
        ...
        require(
            shipment.receiver == _receiver,"Invalid receiver"
        );
