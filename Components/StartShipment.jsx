            ...
            <div className="relative mt-3">
              ...
              <input
                ...
                <button
                  ...
                  className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 rounded-lg ring-offset-2 ring-indogo-600 focus:ring-2"
                  >
                    Get details
                  </button>
                  </form>
